...
import { QuotaEstimatorPage } from '@/pages/QuotaEstimatorPage';
import { ApiKeyQuotasPage } from '@/pages/ApiKeyQuotasPage';
...
const mainRoutes = [
  ...
  { path: '/quota-estimator', element: <QuotaEstimatorPage /> },
  { path: '/api-key-quotas', element: <ApiKeyQuotasPage /> },
